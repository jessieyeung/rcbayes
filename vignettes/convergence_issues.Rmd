...
* The `a` parameters describe the heights of peaks. Use the local maximums within specific age ranges. 
* The `mu` parameters describe the age at which peaks occur. Use the ages associated with local maximums described above. 
* The `c` parameter describes the overall migration level. Use the minimum observed migration rate. 
